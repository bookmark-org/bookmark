defmodule Bookmark.Accounts.User do
  ...
  defp validate_password(changeset, opts) do
    ...
    |> validate_length(:password, min: 12, max: 72, message: "length must be at least 12")
  ...
  """
  def valid_password?(%Bookmark.Accounts.User{hashed_password: hashed_password}, password)
